...
<body>
    ...
    <!-- <div style="position: fixed;background-color: rgba(0, 0, 0, 0.566);z-index:100;height:600px;width:800px;margin:0px;padding:0px;"></div> -->

    <table id="blog-master-container">
        <tr>
...
const footerEl = `
    ...
    <img src="images/conventions/gears.png" class="gears">
    <div id="lamps-div">
      <img src="images/conventions/lamps.png" id="lamps">
    </div>
